<script lang="ts">
	...
	const features = [
		...
		},
		{
			...
			body: 'Skip the multi-gigabyte TeX distribution and the cryptic package errors. Open GlyphX and start writing in seconds.'
		},
		{
			icon: IconFileText,
	...
	/** A comparison cell: `true`/`false` → check / dash, or a short label string. */
	type CompareCell = boolean | string;
	type CompareRow = {
		label: string;
		glyph: CompareCell;
		overleaf: CompareCell;
		desktop: CompareCell;
	};
...
<svelte:head>
	<title>GlyphX — the private LaTeX editor that never leaves your machine</title>
	<meta
		name="description"
		content="GlyphX is a local-first LaTeX editor for researchers, PhD students, and mathematicians. Write papers and theses in real LaTeX — fully offline, with nothing uploaded. Free in your browser, plus a native desktop app."
	/>
</svelte:head>
		...
		<div class="grid items-center gap-12 py-16 lg:grid-cols-[1.05fr_0.95fr] lg:py-24">
			<Reveal variant="up" class="flex flex-col items-start">
				...
				<p class="text-muted-foreground mt-6 max-w-[34rem] text-lg leading-relaxed">
					Write papers, proofs, and theses in real LaTeX — fully offline, with nothing uploaded to
					anyone's servers. Your unpublished work stays yours.
				</p>
...
See <span class="text-brand">\cite</span>&#123;einstein1905&#125;.<span
	...
	<Reveal as="section" variant="up">
		<div class="border-hairline mx-auto max-w-[1140px] border-y px-5 sm:px-6">
			...
			>
				...
				>
				<span class="flex items-center gap-2"
					><span class="bg-brand size-1.5 rounded-full"></span> Fully offline</span
				>
				<span class="flex items-center gap-2"
					><span class="bg-brand size-1.5 rounded-full"></span> No setup</span
				>
				<span class="flex items-center gap-2"
					><span class="bg-brand size-1.5 rounded-full"></span> Free &amp; open source</span
				>
			</div>
		</div>
	</Reveal>
	...
	<section id="features" class="mx-auto max-w-[1140px] px-5 py-20 sm:px-6 sm:py-28">
		<Reveal variant="up">
			...
			>
				<span class="bg-brand size-1.5 rounded-full"></span> Why GlyphX
			</span>
		...
		<div class="mx-auto max-w-[1140px] px-5 py-20 sm:px-6 sm:py-28">
			<Reveal variant="up" class="mx-auto max-w-2xl text-center">
				...
				<p class="text-muted-foreground mt-4 text-lg leading-relaxed">
					...
					— and nothing competing for your attention.
				</p>
			</Reveal>
...
<span class="text-brand">\end</span>&#123;document&#125;</pre>
			...
			>
				<div class="mx-auto flex max-w-xl flex-col items-center">
					...
					<p class="text-primary-foreground/65 mt-4 max-w-md text-base leading-relaxed">
						Start writing in your browser — free, no account — or get the desktop app for fully
						offline work.
					</p>
	...
	<footer class="border-hairline border-t">
		<div
			class="text-muted-foreground mx-auto flex max-w-[1140px] flex-col items-center justify-between gap-4 px-5 py-10 text-sm sm:flex-row sm:px-6"
		>
